...
<div class="matter">
  <div class="container">
    <div class="well well-small"> <a href="<?= base_url(); ?>uploads/sample_products.csv" class="btn btn-info pull-right"><i class="icon-download icon-white"></i> Download Sample File</a> <span class="text-info">You can import maximum 999 products with single csv file.</span><br /><span class="text-warning"><?= lang("csv1"); ?></span><br />
      <?= lang("csv2"); ?> <span class="text-info">(<?= lang("name"); ?>, <?= lang("price"); ?>, <?= lang("tax_rate"); ?>, <?= lang("details"); ?>)</span> <?= lang("csv3"); ?> </div>
    <?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("products/import", $attrib); ?>
    ...
    <div class="control-group">
      <div class="controls"> <?= form_submit('submit', lang("add_products"), 'class="btn btn-primary"');?> </div>
    </div>
    <?= form_close();?>
    <div class="clearfix"></div>
  </div>
