...
$phone = array(
    ...
    <div class="matter">
        <div class="container">
            ...
            <?php $attrib = array('class' => 'form-horizontal'); echo form_open("customers/edit?id=".$id);?>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="controls"> <?= form_submit('submit', lang("update_customer"), 'class="btn btn-primary"');?> </div>
            </div>
            <?= form_close();?> 
        </div>
    </div>
