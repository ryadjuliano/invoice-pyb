...
<head>
    ...
    <style>@page { margin: 0 !important; padding: 0 !important; } html, body { margin: 0 !important; padding: 0 !important; } body, div, span, * { font-family: DejaVu Sans, sans-serif !important; } #wrap { padding: 10px; !important; }</style>
</head>
...
<body>
    <div id="wrap">
        ...
        <div class="row">
            ...
            <div style="clear: both; height: 15px;"></div>
            <div class="col-xs-12">
                    <table width="100%" class="table table-bordered table-hover table-striped" style="margin-bottom: 5px; max-width:100%;">
                        <thead>
                            <tr>
